...
# Initialize stock levels and sales count for each product
product_info = {f'P{num}': {'stock': 100, 'sales_count': 0} for num in range(101, 201)}
...
def generate_daily_report():
    for message in consumer:
        ...
        # Update sales count and stock level
